(async function(){
 ...
 try {
  ...
  document.title='R06-C01 · same-hardware re-aimed challenger';
 ...
 }catch(error){$('r05-error').hidden=false;$('r05-error').textContent='R06-C01 could not finish loading: '+error.message;console.error(error);}
})();
